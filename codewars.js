...
//   43, 44, 'FizzBuzz', 46, 47, 'Fizz', 49, 'Buzz', 'Fizz', 52, 53, 'Fizz', 'Buzz',
//   56, 'Fizz', 58, 59, 'FizzBuzz', 61, 62, 'Fizz', 64, 'Buzz', 'Fizz', 67, 68, 'Fizz',
//   'Buzz', 71, 'Fizz', 73, 74, 'FizzBuzz', 76, 77, 'Fizz', 79, 'Buzz', 'Fizz', 82,
...
const bottleOfBeer = () => {
  let lyrics = []
  for (let i = 99; i > 0; i--){
      lyrics.push(`${i} ${i > 1 ? 'bottles' : 'bottle'} of beer on the wall, ${i} ${i > 1 ? 'bottles' : 'bottle'} of beer.`)
      lyrics.push(`Take one down and pass it around, ${i === 1 ? 'no' : i - 1 } more ${i > 1 ? 'bottles' : 'bottle'} of beer on the wall.`)
    } 
